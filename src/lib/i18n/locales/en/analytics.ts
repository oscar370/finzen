export const enAnalytics = {
  ...
  titles: {
    monthlyBalanceComparison: "Monthly balance comparison",
    balanceByAccount: "Balance by account type",
  ...
  descriptions: {
    mainAccounts:
      "The first three accounts with the highest balance are displayed",
  },
  messages: {
